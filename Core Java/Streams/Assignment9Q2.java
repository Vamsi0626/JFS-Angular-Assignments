...
public class Assignment9Q2 {
    ...
    public static void main(String[] args) {
        ...
        feb23.add(new News(1, "Vamsi", "Gupta", "comment"));
        feb23.add(new News(2, "Anurag", "Vignesh", "comment"));
        feb23.add(new News(3, "Bala", "Ravi", "budget"));
        feb23.add(new News(1, "vijay", "Kanna", "budget "));
        feb23.add(new News(2, "Teja", "surya", "budget"));
        feb23.add(new News(3, "Sarath", "Komal", "costly"));
